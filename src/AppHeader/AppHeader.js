...
import { Menu, Icon, Dropdown, Modal, Checkbox, Button, Grid, TextArea} from "semantic-ui-react";
...
class AppHeader extends Component {
  constructor(props) {
    ...
    this.checkboxShowCaseDetails = React.createRef();
  ...
  settingsModal() {
    ...
    return(
      ...
      <Grid divided='vertically'>
        ...
        <Checkbox ref={this.checkboxShowCaseDetails} label="Show Case Details area" defaultChecked={this.props.appSettings.bShowCaseDetails} /><br />
  ...
  saveSettings() {
    let appSettings = {
      ...
      bShowCaseDetails: this.checkboxShowCaseDetails.current.state.checked,
